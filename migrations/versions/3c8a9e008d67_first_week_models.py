...
def upgrade() -> None:
    ...
    op.create_table(
        'familyobservation', sa.Column(
            'id', sa.Integer(), nullable=False), sa.Column(
            'observation_text', sqlmodel.sql.sqltypes.AutoString(), nullable=False), sa.Column(
                'family_id', sa.Integer(), nullable=True), sa.ForeignKeyConstraint(
                    ['family_id'], ['family.id'], ), sa.PrimaryKeyConstraint('id'))
    op.create_table(
        'patientobservation', sa.Column(
            'id', sa.Integer(), nullable=False), sa.Column(
            'observation_text', sqlmodel.sql.sqltypes.AutoString(), nullable=False), sa.Column(
                'patient_id', sa.Integer(), nullable=True), sa.ForeignKeyConstraint(
